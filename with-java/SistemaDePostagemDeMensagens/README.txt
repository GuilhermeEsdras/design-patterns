Para executar a minha aplicação o professor deve:
  1) Fazer download do arquivo "postagem-guilherme.jar" para uma "pasta_201821250024"
  2) Executar este arquivo .jar (usando a versão 11 ou superior do java)
      Por exemplo:
        java -jar /usr/katyusco/pasta_201821250024/postagem-guilherme.jar <args>
