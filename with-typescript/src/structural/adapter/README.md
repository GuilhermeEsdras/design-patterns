...
![Estrutura do Adapter por Composição](diagramas/Adapter%20-%20Estrutura%20por%20composicao.png)

### Por Herança Múltipla

![Estrutura do Adapter por Herança Múltipla](diagramas/Adapter%20-%20Estrutura%20por%20heranca%20multipla.png)
...
|                                    Bom                                   |                                              Ruim                                              |
|:------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------:|
| Desacopla o código da aplicação de códigos de terceiros                  | Aumenta a complexidade da aplicação (Por outro lado, qual outra solução deveria ser aplicada?) |
